...
% Main script for Project 2

clear; clc;
% Comment put for generating multiple trajectory curves
% close all;
...
% Plotting for a single trajectory curve
figure
hold on
axis([0 80 0 30])
...
% Plotting for multiple trajectories with different parameters
% figure(1)
% hold on
% axis([0 80 0 30])
% title('Rocket Altitude v. Horizontal Distance with Varried Parameters')
% xlabel('Ground Distance [m]')
% ylabel('Altitude [m]')
% plot(posXFull,posZFull,'LineWidth',2)

%% Plot: Thrust

% Plotting for a single thrust curve
figure
hold on
axis([0 0.45 0 200])
...
% Plotting for multiple thrusts with different parameters
% figure(2)
% hold on
% axis([0 0.45 0 200])
% title('Rocket Thrust vs. Time')
